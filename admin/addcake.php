...
<body>
    ...
    <form action="add_file.php" method="post" enctype="multipart/form-data">
        <table align="center">
            <tr><td style="text-align:center;" colspan="2"><h1>Cake Details</h1></td></tr>
            <tr><td>Cake Name:</td><td><input type="text" id="cakename" name="cakename"></td></tr>
            ...
            <tr><td>Flavour:</td><td><input type="text" id="flavour" name="flavour"></td></tr>
            <tr><td>Description:</td><td><textarea rows="4" cols="50" name="description" id ="description"></textarea></td></tr>
            <tr><td>Ingredients:</td><td><textarea rows="4" cols="50" name="ingredients" id ="ingredients"></textarea><br></td></tr>
